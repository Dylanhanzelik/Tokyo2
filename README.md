...
```bash
git clone https://github.com/Dylanhanzelik/Tokyo2.git
cd Tokyo2
...
3. Push your code to the repository:
   ...
   git remote add origin https://github.com/Dylanhanzelik/Tokyo2.git
...
7. Click "Save"
8. Your website will be available at `https://dylanhanzelik.github.io/Tokyo2`
